...
{
    /// <summary>
    /// SQLITE帮助类  具体用法及DEMO参考 http://www.cnblogs.com/nick4/archive/2009/04/06/1430208.html
    /// </summary>
    public class SQLiteHelper
    {
        //数据库连接字符串(web.config来配置)，可以动态更改SQLString支持多数据库.        
        public static string connectionString = "Data Source=" + HttpContext.Current.Server.MapPath(System.Configuration.ConfigurationManager.ConnectionStrings["SQLiteConnectionString"].ConnectionString);
