    ...
    <div>
                <table border="0" align="center" style="margin-top:10px;" cellpadding="4" cellspacing="0" width="97%">
                    ...
                    <tr style="height:25px;font-weight:bold;">
                        ...
                        <td class="border_trb"><input type="text" id="MsgTitle" name="MsgTitle" size="64" value="<%=msgTitle %>" /></td>
                    </tr>
                    <tr style="font-weight:bold;">
                        <td class="border_lbr" width="100">消息內容</td>
                        <td class="border_br"><textarea id="elm1" name="elm1" style="width:860px;height:350px;background:url(img/demobg.jpg) no-repeat right bottom fixed"><%=msgContent %></textarea>
