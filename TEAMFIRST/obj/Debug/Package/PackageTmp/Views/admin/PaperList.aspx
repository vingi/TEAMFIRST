<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperList.aspx.cs" Inherits="TEAMFIRST.Views.admin.PaperList" %>
    ...
    <div>
                <table border="0" align="center" style="margin-top:10px;" cellpadding="3" cellspacing="0" width="97%">
                    <tr align="center" style="height:25px;font-weight:bold;background-color:#99ccff;">
                        <td class="border_all">報道標題</td><td class="border_trb">更新時間</td>
                    ...
                    <tr style="height:22px;" onmouseover="changecolor(this)" onmouseout="returncolor(this)">
                        <td class="border_lbr">報道標題</td><td class="border_br">更新時間</td>
                        <td class="border_br">正常</td><td class="border_br"><a href="#" onclick="javascript:dealNews(1,1);">刪除</a>｜
                        <a href="/Views/admin/EditPaper.aspx?newsId=1">编辑</a>｜
                        <a href="/Views/paper_detail.aspx?naviPage=navi5&newsId=1" target="_blank">瀏覽</a></td>
                    </tr>
                    -->
                </table>
    </div>
        ...
        <script type="text/javascript">
            ...
            function dealNews(newsId, state) {
